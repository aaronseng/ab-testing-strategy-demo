...
namespace Hanser.AB.Shared.Handlers
{
    public class BoostedAttackLogicHandler : IAttackLogicHandler
    {
        ...
        {
            Logger.Log(Runner, "Shared", $"BoostedAttackLogicHandler processing changeSet with Power [{changeSet.Power}] x 2 going to hit Monster with [Health : {_dataProvider.MonsterDataProvider.Monster.Health}]", false, ConsoleColor.Yellow);
        }
